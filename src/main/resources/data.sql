...
INSERT INTO User (id, version, first_name, middle_name, second_name, position, phone, address, is_identified, office_id, citizenship) VALUES
    ...
    (8,  0, 'Велен',        'Станиславович', 'Ежов',     'Разработчик',     '+79536589547', 'г. Саратов, ул. Конечная, 38-5',         TRUE, 4, 643),
...
INSERT INTO Document (id, version, doc_number, doc_date, doc_code, user_id) VALUES
    (1,  0, 9907589458, '2000-01-28', 21, 1),
    (2,  0, 9902456123, '2002-03-15', 21, 2),
    (3,  0, 9905181245, '2005-07-07', 21, 3),
    (4,  0, 9910759632, '2010-04-12', 21, 4),
    (5,  0, 9902658794, '2002-10-11', 21, 5),
    (6,  0, 9915985423, '2015-06-02', 21, 6),
    (7,  0, 7308325486, '2008-05-16', 21, 7),
    (8,  0, 4506245698, '2006-08-24', 21, 8),
    (9,  0, 1913397,    '1999-09-30', 10, 9),
    (10, 0, 5978546,    '1995-02-27', 10, 10)   
;
